    ...
    pub(crate) fn into_staged_welcome_inner<Provider: OpenMlsProvider>(
        ...
        let KeyScheduleResult {
            ...
            let EpochSecretsResult {
                ...
                // [chat_mls patch] retain raw epoch_secret on the join path
                epoch_secret,
            } = self
                .key_schedule
...
impl StagedWelcome {
    ...
    pub fn into_group<Provider: OpenMlsProvider>(
        ...
        let mut mls_group = MlsGroup {
            ...
            // [chat_mls patch] carry the joined epoch's raw epoch_secret onto the group
            epoch_secret: Some(self.epoch_secret),
        };
