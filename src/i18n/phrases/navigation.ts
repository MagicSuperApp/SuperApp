...
export const NAVIGATION: PhraseMap = {
  ...
  'Tôi': { en: 'Me', zh: '我' },
  'Tài khoản': { en: 'Account', zh: '账户' },
  'Truy xuất': { en: 'Trace', zh: '溯源' },
  'Trò chuyện': { en: 'Chat', zh: '聊天' },
  'Việc làm': { en: 'Work', zh: '工作' },
  'Kết đèn': { en: 'Connect', zh: '连灯' },
  ...
  'Gọi': { en: 'Calls', zh: '通话' },
  'Ghim': { en: 'Pins', zh: '置顶' },
  'Tài liệu': { en: 'Docs', zh: '文档' },
  'Vườn': { en: 'Garden', zh: '果园' },
  'Cây': { en: 'Trees', zh: '树木' },
  'Chăm sóc': { en: 'Care', zh: '养护' },

  // ── Cổng xoè (radial menu) ─────────────────────────────────────────────────
  'Chạm một dịch vụ để mở': { en: 'Tap a service to open it', zh: '点按服务即可打开' },
  'Kéo tới một dịch vụ rồi thả để mở': { en: 'Drag to a service and release to open', zh: '拖到服务上松手即可打开' },
  ...
  'Đã thêm Farm vào thanh': { en: 'Farm added to the bar', zh: '已将农场加入导航栏' },
  'vì bạn vừa tạo vườn.': { en: 'because you just created a garden.', zh: '因为你刚创建了果园。' },

  // ── Hành động nhanh ────────────────────────────────────────────────────────
  'Quét cây': { en: 'Scan tree', zh: '扫描树木' },
  'Quét quả': { en: 'Scan fruit', zh: '扫描果实' },
  'Quét vật': { en: 'Scan animal', zh: '扫描动物' },
  'Quét con vật': { en: 'Scan animal', zh: '扫描动物' },
  'Quét nhãn thuốc': { en: 'Scan product label', zh: '扫描药剂标签' },
  'Quét truy xuất': { en: 'Trace scan', zh: '溯源扫描' },
  'Video quả': { en: 'Fruit video', zh: '果实视频' },
  'Nhận diện\ncon vật': { en: 'Identify\nanimal', zh: '识别\n动物' },
  'Quay video\nquả': { en: 'Record fruit\nvideo', zh: '录制果实\n视频' },
  'Thêm Vườn': { en: 'Add garden', zh: '添加果园' },
  'Thêm vườn': { en: 'Add garden', zh: '添加果园' },
  'Thêm đàn': { en: 'Add herd', zh: '添加畜群' },
  'Vườn của tôi': { en: 'My gardens', zh: '我的果园' },
  'Mở ví': { en: 'Open wallet', zh: '打开钱包' },
  'Cho ăn': { en: 'Feed', zh: '喂食' },
  'Tiêm thuốc': { en: 'Vaccinate', zh: '注射' },
  'Cách quét cây': { en: 'How to scan a tree', zh: '如何扫描树木' },
  'Truy xuất nguồn gốc quả': { en: 'Trace fruit origin', zh: '追溯果实来源' },

  // ── Trang chủ ──────────────────────────────────────────────────────────────
  'Truy xuất sầu riêng\ntới từng trái': { en: 'Trace durian\ndown to each fruit', zh: '榴莲溯源\n精确到每一颗' },
  'Định danh blockchain Cardano': { en: 'Cardano blockchain identity', zh: 'Cardano 区块链身份' },
  'Tính năng Trò chuyện sắp\nra mắt': { en: 'Chat is coming\nsoon', zh: '聊天功能\n即将推出' },
  'Tin nhắn xác thực bằng chữ ký': { en: 'Messages authenticated by signature', zh: '由签名认证的消息' },
  'Tìm việc · Đặt thợ\nmọi lĩnh vực': { en: 'Find work · Book help\nin any trade', zh: '找工作 · 预约师傅\n涵盖各行业' },
  'Hợp đồng số · Ký quỹ blockchain': { en: 'Digital contracts · Blockchain escrow', zh: '数字合约 · 区块链托管' },
  'Thu gọn thao tác nhanh': { en: 'Collapse quick actions', zh: '收起快捷操作' },
  'Mở thao tác nhanh': { en: 'Expand quick actions', zh: '展开快捷操作' },
  'Thông tin nhanh': { en: 'At a glance', zh: '快速信息' },
  'Chưa đồng bộ': { en: 'Not synced', zh: '未同步' },
  'Ví của tôi': { en: 'My wallet', zh: '我的钱包' },
  'Trang trại đang theo dõi': { en: 'Farms you follow', zh: '关注的农场' },
  'Tin nhắn ProofChat': { en: 'ProofChat messages', zh: 'ProofChat 消息' },
  'Không có tin mới': { en: 'No new messages', zh: '没有新消息' },
  'Hoạt động gần đây': { en: 'Recent activity', zh: '最近活动' },
  ...
  'Hỏi trợ lý...': { en: 'Ask the assistant...', zh: '向助手提问...' },
  'bạn': { en: 'there', zh: '你' },

  // ── Luồng hướng dẫn (coach mark) ───────────────────────────────────────────
  'Xin chào 👋': { en: 'Hello 👋', zh: '你好 👋' },
  ...
  'Màn hình Chính': { en: 'Home screen', zh: '主屏幕' },
  ...
  'Nút Chính': { en: 'Main button', zh: '主按钮' },
  ...
  'Tôi đã hiểu rồi!': { en: 'Got it!', zh: '我明白了！' },
  'Tôi đã hiểu rồi, đóng hướng dẫn': { en: 'Got it, close the walkthrough', zh: '我明白了，关闭引导' },

  // ── Đăng nhập ──────────────────────────────────────────────────────────────
  'Chào mừng trở lại': { en: 'Welcome back', zh: '欢迎回来' },
  ...
  'Quét khuôn mặt': { en: 'Scan face', zh: '扫描面容' },
  'Quét vân tay': { en: 'Scan fingerprint', zh: '扫描指纹' },
  'Đăng nhập bằng khuôn mặt': { en: 'Sign in with face', zh: '使用面容登录' },
  'Đăng nhập bằng vân tay': { en: 'Sign in with fingerprint', zh: '使用指纹登录' },
  ...
  'Chưa có danh tính PhoenixKey': { en: 'No PhoenixKey identity yet', zh: '尚无 PhoenixKey 身份' },
  'PhoenixKey không khả dụng': { en: 'PhoenixKey unavailable', zh: 'PhoenixKey 不可用' },
  'Đăng nhập sinh trắc học thất bại': { en: 'Biometric sign-in failed', zh: '生物识别登录失败' },
  'Aladin Chat — phiên bản mới': { en: 'Aladin Chat — new version', zh: 'Aladin Chat — 新版本' },
  'Tin nhắn ký số · Escrow tích hợp': { en: 'Digitally signed messages · Built-in escrow', zh: '数字签名消息 · 内置托管' },
  'Đăng ký thợ — nhận 100 MAGIC': { en: 'Register as a pro — get 100 MAGIC', zh: '注册师傅 — 获得 100 MAGIC' },
  'Ưu đãi cho người mới đến 30/04': { en: 'New-user offer until 30 April', zh: '新用户优惠至 4 月 30 日' },
  'Sự kiện cộng đồng & airdrop': { en: 'Community events & airdrops', zh: '社区活动与空投' },
  ...
  'Kích hoạt chip bảo mật để sinh khóa': { en: 'Activate the secure chip to generate the key', zh: '激活安全芯片以生成密钥' },
  ...
  'Đang sinh khóa…': { en: 'Generating key…', zh: '正在生成密钥…' },
  'Bắt đầu xác thực sinh trắc học': { en: 'Start biometric authentication', zh: '开始生物识别认证' },
  'Sinh khóa phần cứng': { en: 'Hardware key generation', zh: '硬件密钥生成' },
  'Khóa riêng nằm trong chip bảo mật, không thể xuất': {
    en: 'The private key lives in the secure chip and cannot be exported',
    zh: '私钥存放在安全芯片中，无法导出',
  },
  'Tạo định danh DID': { en: 'Create the DID', zh: '创建 DID 标识' },
  'Public key được ghi vào danh sách khóa được phép': {
    en: 'The public key is written to the allowed-key list',
    zh: '公钥被写入允许密钥列表',
  },
  'Mã hoá dữ liệu khôi phục': { en: 'Encrypt recovery data', zh: '加密恢复数据' },
  'Mã hoá mạnh bằng khoá lấy từ thiết bị của bạn': {
    en: 'Strong encryption with a key derived from your device',
    zh: '使用源自你设备的密钥进行强加密',
  },
  'Chia nhỏ & lưu trên nhiều thiết bị': { en: 'Split and store across many devices', zh: '分片并存储在多台设备上' },
  ...
  'Vào ứng dụng': { en: 'Enter the app', zh: '进入应用' },
  ...
  'Phiên bản': { en: 'Version', zh: '版本' },

  'Kích Hoạt ví': { en: 'Activate wallet', zh: '激活钱包' },
