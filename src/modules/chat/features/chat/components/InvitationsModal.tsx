        ...
        <View style={styles.sheet}>
          <View style={styles.header}>
            <View style={styles.headerIcon}>
              <Icon name="email-outline" size={20} color={CHAT_THEME.primary} />
            </View>
            <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, gap: 4 }}>
        <View style={styles.titleRow}>
          ...
          <View style={styles.typeChip}>
            <Icon name={meta.icon} size={10} color={CHAT_THEME.primary} />
...
const Empty: React.FC = () => (
  <View style={styles.empty}>
    <View style={styles.emptyIcon}>
      <Icon name="email-check-outline" size={36} color={CHAT_THEME.primary} />
    </View>
...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 15, fontWeight: '800', color: CHAT_THEME.primary },
  titleRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  acceptBtn: { backgroundColor: CHAT_THEME.primary },
