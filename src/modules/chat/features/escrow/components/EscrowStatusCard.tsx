// modules/chat/features/escrow/components/EscrowStatusCard.tsx
...
> = {
  ...
  locked: {
    ...
    bg: withAlpha(CHAT_THEME.primary, 0.10),
  },
  released: {
    label: 'Released',
    icon: 'check-decagram',
...
const styles = StyleSheet.create({
  ...
  amountValue: {
    ...
    color: CHAT_THEME.primaryDeep, letterSpacing: -1,
  },
  amountCurrency: {
    fontSize: 13, fontWeight: '700', color: CHAT_THEME.primary,
  },
});
