// modules/proofchat/features/chat/components/JobRoomItem.tsx
...
const ESCROW_PILL: Record<string, { color: string; label: string; icon: string }> = {
  ...
  locked: { color: PROOFCHAT_THEME.primary, label: 'Đang khóa', icon: 'shield-lock-outline' },
...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 16, fontWeight: '800', color: PROOFCHAT_THEME.primary },
  onlineDot: {
  ...
  jobTitle: { fontSize: 11, color: PROOFCHAT_THEME.primary, fontWeight: '600' },
