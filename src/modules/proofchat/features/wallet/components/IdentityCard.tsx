// modules/proofchat/features/wallet/components/IdentityCard.tsx
//
      ...
      <View style={styles.row}>
          ...
          style={[
            styles.iconBox,
            {
              backgroundColor: identity.verified
                ? withAlpha(PROOFCHAT_THEME.primary, 0.12)
        ...
        >
          <Icon
            ...
            size={20}
            color={identity.verified ? PROOFCHAT_THEME.primary : NEUTRAL.textMuted}
          />
        </View>
        <View style={{ flex: 1 }}>
          <View style={styles.titleRow}>
            ...
            {identity.verified && (
              <View style={styles.verifiedPill}>
                <Icon name="shield-check" size={10} color={PROOFCHAT_THEME.primary} />
...
const styles = StyleSheet.create({
  ...
  refreshLink: {
    fontSize: 11, fontWeight: '700', color: PROOFCHAT_THEME.primary,
  },
});
